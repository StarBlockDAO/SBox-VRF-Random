...
func main() {
	...
	var contractRandomSeed = "109007810264949405695604925633235128374614917367679130440872262778440898396350"
	var nftCount = 21
	...
	for len(nftWinnerList) < nftCount {
		// get random sbox id between 0, 20
		randBox := randInt(0, 20)
